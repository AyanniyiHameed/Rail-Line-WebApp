...
export default function Home() {
  return (
    <>
      ...
      <section className="relative z-10 mx-auto max-w-7xl px-6 py-24 bg-gray-950">
          {/* why choose railline section */}
        <div className="mb-5 py-8 text-white text-center">
            <h2 className="text-3xl font-bold mb-4">Why choose RailLine?</h2>
            <p className="text-lg text-gray-500 max-w-2xl mx-auto">Explore thousands of destinations and uncover hidden gems with fast, 
        ...
        <div className="grid gap-8 md:grid-cols-3">
          ...
          <div className="group rounded-2xl border border-white/10 bg-white/5 p-8 backdrop-blur-lg transition hover:bg-white/10">          {/* wallet */}
            ...
            <h4 className="text-xl font-semibold text-white">Light on the pocket</h4> 
            ...
            {/* green leaf */}
          <div className="group rounded-2xl border border-white/10 bg-white/5 p-8 backdrop-blur-lg transition hover:bg-white/10">          
            ...
            <h3 className="text-xl font-semibold text-white">Green by design</h3>
